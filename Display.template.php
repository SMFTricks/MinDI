...
function template_main()
{
	...
	while ($message = $context['get_message']())
	{
		...
		if ($context['can_report_moderator'])
			echo '
								<a href="', $scripturl, '?action=reporttm;topic=', $context['current_topic'], '.', $message['counter'], ';msg=', $message['id'], '"><img src="', $settings['images_url'], '/report.png" alt="', $txt['report_to_mod'], '" title="', $txt['report_to_mod'], '" /></a> &nbsp;';
